...
const MODULOS = [
  {
    ...
    preguntas: [
      ...
      { pregunta: "¿Cuál es una buena forma de proteger nuestras cuentas?", opciones: ["Utilizar contraseñas seguras.", "Usar la misma contraseña para todo.", "Compartir la contraseña con amigos.", "Escribir la contraseña en publicaciones."], correcta: 0 },
  ...
  },
  {
    ...
    preguntas: [
      ...
      { pregunta: "¿Cuál de estos datos debemos proteger especialmente?", opciones: ["Nuestra contraseña.", "Nuestro color favorito.", "Nuestra comida favorita.", "Nuestro deporte preferido."], correcta: 0 },
  ...
  },
  {
    ...
    preguntas: [
      ...
      { pregunta: "¿Qué puede pasar con una foto publicada en internet?", opciones: ["Puede ser compartida por otras personas.", "Solo puede verla el dueño.", "Desaparece automáticamente.", "Nunca puede descargarse."], correcta: 0 },
  ...
  },
  {
    ...
    preguntas: [
      ...
      { pregunta: "¿Cuál puede formar parte de nuestro rastro digital?", opciones: ["Publicaciones y comentarios en redes sociales.", "Únicamente nuestras fotografías impresas.", "La ropa que utilizamos.", "Los objetos de nuestra casa."], correcta: 0 },
  ...
  },
  {
    ...
    preguntas: [
      { pregunta: "¿Cuál es una oportunidad que ofrece el mundo digital?", opciones: ["Acceder a información y aprender.", "Perder toda nuestra información.", "Evitar cualquier comunicación.", "No poder estudiar."], correcta: 0 },
  ...
  },
  {
    ...
    preguntas: [
      { pregunta: "¿Qué significa conectarse con responsabilidad?", opciones: ["Utilizar internet de manera segura, respetuosa y consciente.", "Estar conectado todo el día.", "Compartir toda nuestra información.", "Aceptar a cualquier persona en redes sociales."], correcta: 0 },
